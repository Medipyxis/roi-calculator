...
export default function Index() {
  ...
  // Financial Inputs
  const [annualRevenuePerProvider, setAnnualRevenuePerProvider] =
    useState(750000);
  ...
  const calculations = useMemo(() => {
    // Medipyxis Costs
    const medipyxisStartup = isSoloPractice
      ? MEDIPYXIS_STARTUP_SOLO
      : MEDIPYXIS_STARTUP_STANDARD;
    ...
    const currentMonthlyPerUser = Object.values(currentSoftwareCosts).reduce(
      (a, b) => a + b,
      0,
    );
    ...
    const salesforceMonthlyPerUser =
      SALESFORCE_HC_LICENSE + sfAdditionalToolsCost;
    const salesforceMonthlyTotal = salesforceMonthlyPerUser * providers;
    const salesforce3YearCost =
      SALESFORCE_UPFRONT + salesforceMonthlyTotal * 12 * 3;
    ...
    const hoursSavedPerProviderPerYear =
      hoursSavedPerProviderPerDay * WORKING_DAYS_PER_YEAR;
    ...
    const denialRateImprovement =
      (currentDenialRate - MEDIPYXIS_DENIAL_RATE) / 100;
    const additionalRevenuePerProviderPerYear =
      annualRevenuePerProvider * denialRateImprovement;
    const totalAdditionalRevenue3Year =
      additionalRevenuePerProviderPerYear * providers * 3;

    // Total Benefits (vs current state - the realistic comparison)
    const totalBenefits3Year =
      savingsVsCurrent + timeSavingsValue3Year + totalAdditionalRevenue3Year;
    ...
    const totalBenefitsVsSalesforce =
      savingsVsSalesforce + timeSavingsValue3Year + totalAdditionalRevenue3Year;
    const roiVsSalesforce =
      (totalBenefitsVsSalesforce / medipyxis3YearCost) * 100;
    ...
    const perProviderTimeSavings3Year =
      hoursSavedPerProviderPerYear * 3 * PROVIDER_HOURLY_RATE;
    const perProviderTotalBenefit =
    ...
    const monthlyBenefit =
      savingsVsCurrent / 36 +
      timeSavingsValue3Year / 36 +
      totalAdditionalRevenue3Year / 36;
    ...
    >
      ...
      <div className="roi-content-wrapper">
        ...
        <div className="roi-hero-header">
          ...
          >
            Replace 8 fragmented tools with one unified platform. See your
            3-year savings.
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <span style={{ fontSize: "14px", color: "#212371" }}>
                    Solo Practice
                  </span>
                  <div
                    style={{
                ...
                <div>
                  ...
                  >
                    <label style={{ fontSize: "14px", color: "#8893A8" }}>
                      Providers
                    </label>
                    <span
                      style={{
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      {formatCurrency(annualRevenuePerProvider)}
                    </span>
                  </div>
                  <input
                    type="range"
                    ...
                    onChange={(e) =>
                      setAnnualRevenuePerProvider(Number(e.target.value))
                    }
                    style={{
                      width: "100%",
                      height: "6px",
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCurrentDenialRate(Number(e.target.value))
                    }
                    style={{
                      width: "100%",
                      height: "6px",
                  ...
                  {Object.entries(currentSoftwareCosts).map(([key, value]) => (
                    ...
                    >
                      ...
                      <input
                        ...
                        value={value}
                        onChange={(e) =>
                          updateSoftwareCost(key, e.target.value)
                        }
                        style={{
                          flex: 1,
                          padding: "8px 12px",
                      ...
                      />
                      <span style={{ fontSize: "12px", color: "#8893A8" }}>
                        /mo
                      </span>
                    </div>
                  ))}
          ...
          >
            ...
            <div className="roi-hero-metrics">
              ...
              >
                ...
                >
                  {formatNumber(calculations.roiVsCurrent)}%
                </div>
                <div
                  style={{
                    fontSize: "11px",
            ...
            >
              ...
              <ComparisonBar
                ...
                labels={[
                  "Medipyxis",
                  "Current 8 Tools",
                  "Salesforce HC + 6 Tools",
                ]}
                colors={["#37ca37", "#f59e0b", "#ef4444"]}
              />

              <div
                className="roi-comparison-grid"
                style={{
                  marginTop: "20px",
                  padding: "20px",
                  background: "#F7F8F9",
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: "13px", color: "#212371" }}>
                    {formatCurrency(calculations.medipyxisStartup)} startup +{" "}
                    {formatCurrency(calculations.medipyxisMonthly)}/mo
                  </div>
                  <div
                    style={{
                      fontSize: "11px",
                ...
                <div>
                  ...
                  <div style={{ fontSize: "13px", color: "#212371" }}>
                    {formatCurrency(calculations.currentMonthlyTotal)}/mo across
                    8 systems
                  </div>
                  <div
                    style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: "13px", color: "#212371" }}>
                    $250K +{" "}
                    {formatCurrency(calculations.salesforceMonthlyTotal)}/mo
                  </div>
                  <div
                    style={{
                      fontSize: "11px",
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      >
                        {formatCurrency(calculations.currentMonthlyPerUser)}
                      </td>
                      <td
                        style={{
                          padding: "14px 16px",
                      ...
                      >
                        {formatCurrency(calculations.salesforceMonthlyPerUser)}
                      </td>
                    </tr>
                    <tr>
                      <td
                    ...
                    <tr>
                      ...
                      >
                        6 tools (+
                        {formatCurrency(calculations.sfAdditionalToolsCost)}
                        /user)
                      </td>
                    </tr>
                    <tr>
                      ...
                      >
                        {formatCurrency(calculations.medipyxis3YearCost)}
                      </td>
                      <td
                        style={{
                          padding: "14px 16px",
                      ...
                      >
                        {formatCurrency(calculations.current3YearCost)}
                      </td>
                      <td
                        style={{
                          padding: "14px 16px",
                      ...
                      >
                        {formatCurrency(calculations.salesforce3YearCost)}
                      </td>
                    </tr>
                    <tr>
                      <td
                    ...
                    <tr>
                      ...
                      >
                        {formatCurrency(
                          calculations.totalAdditionalRevenue3Year,
                        )}
                      </td>
                      <td
                        style={{
            ...
            >
              ...
              <div className="roi-provider-grid">
                <div>
                  ...
                  >
                    {formatCurrency(
                      calculations.perProviderSoftwareSavings3Year,
                    )}
                  </div>
                </div>
                <div>
                  ...
                  >
                    {formatCurrency(calculations.perProviderTimeSavings3Year)}
                  </div>
                </div>
                <div>
                  <div
                  ...
                  >
                    {formatCurrency(calculations.perProviderRevGain3Year)}
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  {formatCurrency(calculations.perProviderTotalBenefit)}
                </span>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                {isSoloPractice
                  ? "a solo practice"
                  : `a practice with ${providers} providers across ${clinics} ${clinics === 1 ? "location" : "locations"}`}
                , Medipyxis delivers a{" "}
                <strong style={{ color: "#37ca37" }}>
                  {formatNumber(calculations.roiVsCurrent)}% ROI
                </strong>{" "}
                over 3 years compared to your current 8-tool stack. By
                consolidating everything into one platform, reducing
                documentation time by 70%, and cutting denial rates from{" "}
                {currentDenialRate}% to under 1%, your total benefit is{" "}
                <strong style={{ color: "#37ca37" }}>
                  {formatCurrency(calculations.netGain3Year)}
                </strong>
                . The {formatCurrency(calculations.medipyxisStartup)} startup
                investment pays back in just{" "}
                <strong style={{ color: "#188bf6" }}>
                  {calculations.paybackMonths.toFixed(1)} months
                </strong>
                . Compared to building on Salesforce Health Cloud (which only
                replaces 2 of 8 tools and costs{" "}
                {formatCurrency(calculations.salesforce3YearCost)} over 3
                years), Medipyxis saves you an additional{" "}
                <strong style={{ color: "#37ca37" }}>
                  {formatCurrency(calculations.savingsVsSalesforce)}
                </strong>
                .
              </p>
            </div>
            ...
            >
              * Estimates based on industry averages and typical Medipyxis
              outcomes. Actual results may vary based on practice specifics.
            </div>
          </div>
        </div>
      </div>
